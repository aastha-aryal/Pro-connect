...
const Verification = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#0b1620] to-[#2b3b49] p-6">
      <div className="max-w-xl w-full bg-[#243240]/90 border border-gray-700 rounded-2xl p-8 shadow-2xl text-center">
        <div className="mx-auto w-28 h-28 rounded-full bg-gradient-to-r from-[#31d7c9] via-[#00F5FF] to-[#c13497] flex items-center justify-center mb-6 shadow-xl">
